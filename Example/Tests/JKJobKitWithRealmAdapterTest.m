//
//  JKJobKitWithRealmAdapterTest.m
//  JobKit
//
//  Created by Cristian Bica on 05/04/15.
...
@interface JKJobKitWithRealmAdapterTest : XCTestCase
- (void)setupManager;
- (void)cleanupManager;
@end

@implementation JKJobKitWithRealmAdapterTest
