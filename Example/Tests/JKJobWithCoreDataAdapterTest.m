//
//  JKJobWithCoreDataAdapterTest.m
//  JobKit
//
//  Created by Cristian Bica on 07/04/15.
...
@interface JKJobWithCoreDataAdapterTest : XCTestCase
- (void)setupManager;
- (void)cleanupManager;
@end

@implementation JKJobWithCoreDataAdapterTest
...
- (void)setupManager {
  ...
  [(JKCoreDataAdapter *)[JobKit defaultManager].storage cleanUp];
  [JobKit start];
}
